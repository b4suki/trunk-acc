module RedboxHelper
  ...
  def url_to_remote_redbox(name, link_to_remote_options = {}, html_options = {})
    p "xxx"
    @uses_redbox = true
    id = id_from_url(link_to_remote_options[:url], html_options[:id])
    hidden_content_id = "hidden_content_#{id}"
    ...
    return build_hidden_content(hidden_content_id) + remote_function(name, link_to_remote_options, html_options)
  end
